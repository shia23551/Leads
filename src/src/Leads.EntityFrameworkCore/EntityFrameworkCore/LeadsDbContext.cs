    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(LeadsConsts.DbTablePrefix + "Companies", LeadsConsts.DbSchema);
            ...
            b.Property(x => x.TaxId).HasMaxLength(CompanyConsts.TaxIdLength);
            b.Property(x => x.IndustryCategory).HasMaxLength(CompanyConsts.MaxIndustryCategoryLength);
            b.Property(x => x.ContactPerson).HasMaxLength(CompanyConsts.MaxContactPersonLength);
            b.Property(x => x.PhoneNumber).HasMaxLength(CompanyConsts.MaxPhoneNumberLength);
            b.Property(x => x.Website).HasMaxLength(CompanyConsts.MaxWebsiteLength);
            b.Property(x => x.EmployeeCount).HasDefaultValue(0);
            b.Property(x => x.CapitalAmount).HasPrecision(18, 2).HasDefaultValue(0m);
